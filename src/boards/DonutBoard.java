...
public class DonutBoard extends Board{
...
//
        ...
        row0.add(new Square(true, new ArrayList<>(Arrays.asList(0,2))));
        row0.add(new Square(true, new ArrayList<>(Arrays.asList(0,3))));
        row0.add(new Square(true, new ArrayList<>(Arrays.asList(0,4))));
        row0.add(new Square(true, new ArrayList<>(Arrays.asList(0,5))));
        row0.add(new Square(true, new ArrayList<>(Arrays.asList(0,6))));
        row0.add(new Square(true, new ArrayList<>(Arrays.asList(0,7))));
...
//        row0.add(new Square(false, new ArrayList<>(Arrays.asList(0,11))));
        ...
        row1.add(new Square(true, new ArrayList<>(Arrays.asList(1,1))));
        row1.add(new Square(true, new ArrayList<>(Arrays.asList(1,2))));
        ...
        row1.add(new Square(true, new ArrayList<>(Arrays.asList(1,7))));
        row1.add(new Square(true, new ArrayList<>(Arrays.asList(1,8))));
        row1.add(new Square(false, new ArrayList<>(Arrays.asList(1,9))));

        // Row 2
        ArrayList<Square> row2 = new ArrayList<>();
        row2.add(new Square(true, new ArrayList<>(Arrays.asList(2,0))));
        row2.add(new Square(true, new ArrayList<>(Arrays.asList(2,1))));
        ...
        row2.add(new Square(true, new ArrayList<>(Arrays.asList(2,8))));
        row2.add(new Square(true, new ArrayList<>(Arrays.asList(2,9))));

        // Row 3
        ArrayList<Square> row3 = new ArrayList<>();
        row3.add(new Square(true, new ArrayList<>(Arrays.asList(3,0))));
        ...
        row3.add(new Square(false, new ArrayList<>(Arrays.asList(3,4))));
        row3.add(new Square(false, new ArrayList<>(Arrays.asList(3,5))));
        ...
        row3.add(new Square(true, new ArrayList<>(Arrays.asList(3,9))));
        ...
        row4.add(new Square(false, new ArrayList<>(Arrays.asList(4,3))));
        row4.add(new Square(false, new ArrayList<>(Arrays.asList(4,4))));
        row4.add(new Square(false, new ArrayList<>(Arrays.asList(4,5))));
        row4.add(new Square(false, new ArrayList<>(Arrays.asList(4,6))));
        ...
        row5.add(new Square(false, new ArrayList<>(Arrays.asList(5,3))));
        row5.add(new Square(false, new ArrayList<>(Arrays.asList(5,4))));
        row5.add(new Square(false, new ArrayList<>(Arrays.asList(5,5))));
        row5.add(new Square(false, new ArrayList<>(Arrays.asList(5,6))));
...
//        row5.add(new Square(true, new ArrayList<>(Arrays.asList(5,11))));
        ...
        row6.add(new Square(true, new ArrayList<>(Arrays.asList(6,0))));
        ...
        row6.add(new Square(false, new ArrayList<>(Arrays.asList(6,4))));
        row6.add(new Square(false, new ArrayList<>(Arrays.asList(6,5))));
        ...
        row6.add(new Square(true, new ArrayList<>(Arrays.asList(6,9))));
...
//        row6.add(new Square(true, new ArrayList<>(Arrays.asList(6,11))));
        ...
        row7.add(new Square(true, new ArrayList<>(Arrays.asList(7,0))));
        row7.add(new Square(true, new ArrayList<>(Arrays.asList(7,1))));
        ...
        row7.add(new Square(true, new ArrayList<>(Arrays.asList(7,8))));
        row7.add(new Square(true, new ArrayList<>(Arrays.asList(7,9))));
...
//        row7.add(new Square(false, new ArrayList<>(Arrays.asList(7,11))));
        ...
        row8.add(new Square(true, new ArrayList<>(Arrays.asList(8,1))));
        row8.add(new Square(true, new ArrayList<>(Arrays.asList(8,2))));
        ...
        row8.add(new Square(true, new ArrayList<>(Arrays.asList(8,7))));
        row8.add(new Square(true, new ArrayList<>(Arrays.asList(8,8))));
...
//        row8.add(new Square(false, new ArrayList<>(Arrays.asList(8,11))));
        ...
        row9.add(new Square(true, new ArrayList<>(Arrays.asList(9,2))));
        row9.add(new Square(true, new ArrayList<>(Arrays.asList(9,3))));
        row9.add(new Square(true, new ArrayList<>(Arrays.asList(9,4))));
        row9.add(new Square(true, new ArrayList<>(Arrays.asList(9,5))));
        row9.add(new Square(true, new ArrayList<>(Arrays.asList(9,6))));
        row9.add(new Square(true, new ArrayList<>(Arrays.asList(9,7))));
